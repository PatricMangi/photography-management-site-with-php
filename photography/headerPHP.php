...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html">Anna Sola <sup>Photography</sup></a>
    <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="client.php">clients lists</a>
                            <a class="nav-link" href="client_email.php">Send email to clients</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="Photo_shoot.php">Photoshoot lists</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Send email to clients</a>
                        </nav>
                    </div>
            ...
            <div class="sb-sidenav-footer">
                <div class="small">Log in needed</div>
                <?php else: ?>
